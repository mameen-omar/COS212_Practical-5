...
result = TreapOperations.findKey(root,23687);
		...
		result = TreapOperations.findKey(root,43546);
		System.out.println("The second result is " + result.getValue());

		TreapOperations.rotateDown(node8);
		result = TreapOperations.findKey(root,43546);
		System.out.println("The third result is " + result.getValue());

		TreapOperations.rotateUp(node8);
		result = TreapOperations.findKey(root,43546);
		System.out.println("The fourth result is " + result.getValue());
